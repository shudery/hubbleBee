...
var domain = 'http://doc.ucweb.local/display/IMDXXL/'
	/*------------------种子信息设置---------------------------*/
	//种子标识
var seedName = 'co-business-khaskhabar-hi';
//默认抽链区域，黑白名单
var seed_xpath = "//div[@id='allnews-list']";
var white_pattern = "http://business.khaskhabar.com/.*(html)$";
var black_pattern = "";
//种子名称
var task = [];
var seedNames = [
	
'navbharattimes-astro',
'navbharattimes-astro-photo',
'navbharattimes-autophoto',
'navbharattimes-autovideo',
'navbharattimes-beautyphoto',
'navbharattimes-briefnews',
'navbharattimes-businessdictionary',
'navbharattimes-businessnews',
'navbharattimes-businessphoto',
'navbharattimes-businessvideo',
'navbharattimes-celebsphoto',
'navbharattimes-chutkule',
'navbharattimes-fashionvideo'
